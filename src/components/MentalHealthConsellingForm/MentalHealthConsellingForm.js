...
class MentalHealthConsellingForm extends React.Component {
  constructor(props) {
    super(props);
    ...
    if (
      ...
      saveEmergencyContact(body).then((data) => {
        if (data.data.status === "success") {
          toast.success("Mental Health Counselling data added successfully", {
            position: "top-center",
            autoClose: 3000,
            hideProgressBar: false,
            closeOnClick: true,
...
export default withStyles(styles)(withRouter(MentalHealthConsellingForm));
