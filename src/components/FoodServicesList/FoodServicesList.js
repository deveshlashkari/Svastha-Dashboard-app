...
class FoodServicesList extends React.Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount = () => {
    getListOfEmergencyCategory("Food/Meal Services").then((data) => {
      console.log(data);
      let tempArr = [];
    ...
    return this.state.isLoading ? (
      ...
      <>
        ...
        <Container maxWidth="xl" component="main" style={{ marginTop: "20px" }}>
          ...
          {this.state.foodServicesData.length !== 0 ? (
            <TableContainer component={Paper}>
              <Table className={classes.table} aria-label="simple table">
                ...
                <TableBody>
                  {this.state.foodServicesData.map((data) => (
                    <TableRow>
...
export default withStyles(styles)(withRouter(FoodServicesList));
