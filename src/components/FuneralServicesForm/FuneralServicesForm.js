...
class FuneralServicesForm extends React.Component {
  constructor(props) {
    super(props);
    ...
    if (
      ...
      saveEmergencyContact(body).then((data) => {
        if (data.data.status === "success") {
          toast.success("Funeral Service data added successfully", {
            position: "top-center",
            autoClose: 3000,
            hideProgressBar: false,
            closeOnClick: true,
      ...
      <>
        ...
        <Container component="main" maxWidth="lg">
          ...
          <div className={classes.paper}>
            <Typography variant="h3">Funeral Services</Typography>
            <Typography
              style={{
            ...
            >
              Share details of funeral service providers in your city
            </Typography>
...
export default withStyles(styles)(withRouter(FuneralServicesForm));
