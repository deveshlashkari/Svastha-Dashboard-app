...
class AmbulanceList extends React.Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount = () => {
    getListOfEmergencyCategory("Ambulance").then((data) => {
      let tempArr = [];
    ...
    return this.state.isLoading ? (
      ...
      <>
        ...
        <Container maxWidth="xl" component="main" style={{ marginTop: "20px" }}>
          ...
          {this.state.ambulanceData.length !== 0 ? (
            <TableContainer component={Paper}>
              <Table className={classes.table} aria-label="simple table">
                ...
                <TableBody>
                  {this.state.ambulanceData.map((data) => (
                    <TableRow>
...
export default withStyles(styles)(withRouter(AmbulanceList));
