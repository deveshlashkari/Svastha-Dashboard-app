...
class FoodServicesForm extends React.Component {
  constructor(props) {
    super(props);
    ...
    if (
      ...
      saveEmergencyContact(body).then((data) => {
        if (data.data.status === "success") {
          toast.success("Food Services data added successfully", {
            position: "top-center",
            autoClose: 3000,
            hideProgressBar: false,
            closeOnClick: true,
      ...
      <>
        ...
        <Container component="main" maxWidth="lg">
          ...
          <div className={classes.paper}>
            <Typography variant="h3">Food Services Form</Typography>
            <Typography
              style={{
            ...
            >
              Share details of food services in your city
            </Typography>
...
export default withStyles(styles)(withRouter(FoodServicesForm));
