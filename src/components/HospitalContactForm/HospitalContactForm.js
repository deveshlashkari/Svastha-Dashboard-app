      ...
      <Container component="main" maxWidth="lg">
        ...
        <div className={classes.paper}>
          <Typography variant="h3">
            Share Information about Available Oxygen Beds
          </Typography>
          <Typography
            style={{ borderBottom: "2px solid #E24047", marginBottom: "15px" }}
          >
            You can share any hospitals around you which you know have beds for
            COVID-19 patients through this form.
          </Typography>
          <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
              <TextField
                id="outlined-basic"
                label="Number of Oxygen Beds Available"
                variant="outlined"
                fullWidth
                InputLabelProps={{
                  classes: {
