...
class TestingAndDiagnosticsList extends React.Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount = () => {
    getListOfEmergencyCategory("Testing and Diagnostics").then((data) => {
      let tempArr = [];
    ...
    return this.state.isLoading ? (
      ...
      <>
        ...
        <Container maxWidth="xl" component="main" style={{ marginTop: "20px" }}>
          ...
          {this.state.testingList.length !== 0 ? (
            <TableContainer component={Paper}>
              <Table className={classes.table} aria-label="simple table">
                ...
                <TableBody>
                  {this.state.testingList.map((data) => (
                    <TableRow>
...
export default withStyles(styles)(withRouter(TestingAndDiagnosticsList));
